...
from app.schemas.job_description import JobDescriptionCreate, JobDescriptionResponse , PaginatedJobDescriptionResponse
...
@router.get("/", response_model=PaginatedJobDescriptionResponse)
def list_all(
    skip: int = 0,
    ...
    return list_job_descriptions(db, current_user.id, skip, limit)
